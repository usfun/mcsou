...
$(".copy").click(function(){if($(this).data("type")=="quark"){var c = nmdecode($(this).data("url"))}else{var c="【橘子盘搜nmme.cc】标题："+$(this).data("title")+"，链接："+nmdecode($(this).data("url"))+"，提取码："+$(this).data("code")};var a=new ClipboardJS(".copy",{text:function(){return c}});a.on("success",function(a){showDefault('复制成功，打开网盘APP即可保存！', 2);});a.on("error",function(a){})});
